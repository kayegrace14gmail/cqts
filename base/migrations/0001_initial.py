    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moisture_content', models.CharField(max_length=200)),
                ('color', models.CharField(max_length=200)),
                ('sold_to_exporter', models.BooleanField(default=False)),
                ('sold_to_buyer', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('buyer', models.ForeignKey(limit_choices_to={'group__name': 'Buyer'}, on_delete=django.db.models.deletion.CASCADE, related_name='buyer_batches', to=settings.AUTH_USER_MODEL)),
                ...
                ('exporter', models.ForeignKey(limit_choices_to={'group__name': 'Exporter'}, on_delete=django.db.models.deletion.CASCADE, related_name='exporter_batches', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
